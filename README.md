...
More information about the archiving project can be found on the ArchiveTeam wiki: [Blingee](http://archiveteam.org/index.php?title=Blingee)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Blingee" project in the Warrior interface.
...
**This project requires [lxml](http://lxml.de/installation.html) and [requests](http://www.python-requests.org/).**
...
### For openSUSE:
    ...
    zypper install liblua5_1 lua51 lua51-devel screen python-pip libgnutls-devel bzip2 python-devel gcc make python-lxml python-requests
    pip install --upgrade seesaw
    [... pretty much the same as above ...]
...
6. `screen su -c "cd /home/archiveteam/blingee-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
